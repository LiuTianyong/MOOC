            ...
            <table class="layui-table" border="1">
                ...
                <c:forEach items="${admin}" var="obj">
                    <tr>
                        ...
                        <c:if test="${obj.teacherApprove == 0 }">
                            <th>审核未通过</th>
                        </c:if>
                        <c:if test="${obj.teacherApprove == 1 }">
                            <th>审核通过</th>
                        </c:if>
                        ...
                        <td>
                            <a href="queryUpdateInfo?teacherApprove=${obj.teacherApprove}&amp;updateId=${obj.teacherId}&amp;updateInfo=${1}" class="layui-btn" >通过</a>
                            <a href="queryUpdateInfo?teacherApprove=${obj.teacherApprove}&amp;updateId=${obj.teacherId}&amp;updateInfo=${0}" class="layui-btn layui-btn-danger" >不通过</a>
