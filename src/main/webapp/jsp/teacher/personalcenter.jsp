...
<body>
    ...
    <div><a href="${ctx}/teacher/teacherinfomodify?teacherId=${TEACHER.teacherId}">个人信息修改</a></div>
    <div><a href="${ctx}/teacher/lookpassword?userId=${TEACHER.teacherId}">点击修改账号密码</a></div>
</body>
</html>
