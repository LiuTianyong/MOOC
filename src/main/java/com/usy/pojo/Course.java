...
public class Course {
    ...
    //课程下的所有章节
    private List<CourseChap> courseChaps;

    public List<CourseChap> getCourseChaps() {
        return courseChaps;
    }

    public void setCourseChaps(List<CourseChap> courseChaps) {
        this.courseChaps = courseChaps;
    }
